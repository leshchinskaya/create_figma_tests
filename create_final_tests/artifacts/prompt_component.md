...
Требования приложены отдельными файлами, используй их

### Swagger-спецификация

Swagger тоже может быть прикреплен отдельным файлом
...
* description - должен содержать название файла ТЗ и ссылку на дизайн. Каждый пункт на отдельной
  строке
          ...
          формате "Проверить элемент" для читаемости.
            ...
            * Глобальные навигационные элементы (Tab Bar, Header итд)
                ...
                * Источник информации: Часто такие элементы явно указываются в артефактах, не связанных с основным
                  текстом ТЗ. Ты обязан анализировать все источники на предмет таких
                  компонентов.
