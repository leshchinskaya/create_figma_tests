        ...
        * Логика совпадает с успешной отправкой запроса со следующими уточнениями:
            ...
            * Как описывать проверку без интернета.
                * Одна проверка формата "выключить интернет - сделать запрос". В таком случае обработка == обработке без
                  интернета (например no connection state, снек с текстом про интернет итд).
    ...
    2. PTR с ошибкой
        ...
        * Логика совпадает с отправкой запроса с ошибкой со следующими уточнениями:
            * Внимательно учитывай обработку ошибки. В основном это снек, но может быть и Error State, тогда нужно
              ...
              снек и заглушка.
            * По умолчанию если ошибка не описана - предполагай что будет появляться снекбар, а содержимое экрана
              останется.
